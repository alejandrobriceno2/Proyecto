...
class Especie:
    def __init__(self, id, nombre, clasificacion, designacion, altura, vida_promedio, color_cabello, color_piel, color_ojos, lengua_materna, mundo_natal, nombres_prsonajes_pertenecientes_especie):
        self.id=id
        self.nombre=nombre
